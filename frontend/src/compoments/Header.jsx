...
function Header() {
  return (
    <header className="flex justify-center sm:justify-between bg-black text-gray-300 p-4 px-6 shadow-lg">
        ...
        <Link to="/" className="flex gap-2 items-center font-bold bg-gradient-to-l from-indigo-500 via-red-500 to-blue-500 text-transparent bg-clip-text"> 
            <TbBrandAbstract className="size-4 sm:hidden text-[aqua]"/>
            Submit a request
        </Link>
    </header>
  )
